...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:joao\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=554891635455:+55 838157-2957\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de joao. Registre-se para fazer amizade com o bot joao por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar joao|14\n\n──「 joao BOT 」──`,
...
// recursos anime, random @joao
          ...
          reply('Espere..')
				...
				case 'porno':
					...
					buffer = await getBuffer (`data:image/jpeg;base64,
